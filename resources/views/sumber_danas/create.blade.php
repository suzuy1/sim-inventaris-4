...
<div class="container mx-auto px-4 py-8">
    <div class="bg-white shadow-lg rounded-xl overflow-hidden max-w-2xl mx-auto">
        <div class="p-6 border-b border-gray-200">
            <h1 class="text-2xl font-bold text-gray-800">Tambah Sumber Dana Baru</h1>
        </div>
        <div class="p-6">
            <form action="{{ route('sumber_danas.store') }}" method="POST">
                @csrf
                <div class="mb-4">
                    <label for="kode_sumber_dana" class="block text-gray-700 text-sm font-bold mb-2">Kode Sumber Dana:</label>
                    <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('kode_sumber_dana') border-red-500 @enderror" id="kode_sumber_dana" name="kode_sumber_dana" value="{{ old('kode_sumber_dana') }}" required>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('nama_sumber_dana') border-red-500 @enderror" id="nama_sumber_dana" name="nama_sumber_dana" value="{{ old('nama_sumber_dana') }}" required>
